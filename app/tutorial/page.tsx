    ...
    <div style={{ minHeight: '100vh', background: '#080808', color: '#fff', fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px 100px' }}>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: 80, color: '#333', background: '#111', borderRadius: 16, border: '1px dashed #1a1a1a' }}>
            <div style={{ fontSize: 48, marginBottom: 16 }}>🎓</div>
            <p>এখনও কোনো টিউটোরিয়াল নেই।<br />Admin Panel থেকে যোগ করুন।</p>
            <button onClick={() => router.push('/admin/dashboard')}
              style={{ marginTop: 20, background: '#1a1a1a', color: '#aaa', border: '1px solid #333', padding: '10px 20px', borderRadius: 8, cursor: 'pointer', fontSize: 14 }}>
              Admin Panel →
            </button>
          </div>
        ) : (
